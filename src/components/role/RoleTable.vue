        ...
        <td class="p-2">
          <div class="w-min">
            <Menu as="div" class="relative text-left">
              ...
              >
                <MenuItems class="z-10 w-max right-0 absolute divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-hidden">
                  <div class="px-1 py-1">
                    <MenuItem v-if="!role.virtual" v-slot="{ active }">
                    <button @click="edit_members(role.id)" :class="[ active ? 'bg-violet-500 text-white' : 'text-gray-900', 'group flex w-full rounded-md px-2 py-2 text-xs']">
